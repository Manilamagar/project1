    ...
    <div className="flex flex-col flex-1 overflow-y-auto">
      <nav className="flex flex-col flex-1 overflow-y-auto bg-gradient-to-b from-gray-700 to-blue-500 px-2 py-4 gap-10 rounded-2xl">
        <div>
          ...
          <div className="flex items-center px-4 py-2 text-gray-100 hover:bg-gray-700">Client ID: N-0195</div>
          <div className="flex items-center px-4 py-2 text-gray-100 hover:bg-gray-700">Academic year: 2082</div>
        </div>
        <div className="flex flex-col flex-1 gap-3">
          ...
          <a href="#" className="flex items-center px-4 py-2 mt-2 text-gray-100 hover:bg-gray-400 hover:bg-opacity-25 rounded-2xl">
            <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 32 32" style={{marginRight: 8}}>
          ...
          <a href="#" className="flex items-center px-4 py-2 mt-2 text-gray-100 hover:bg-gray-400 hover:bg-opacity-25 rounded-2xl">
            <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" style={{marginRight: 8}}>
      ...
      <div className="flex items-center px-4">
        <div className="relative mx-auto text-gray-600">
          ...
          <button type="submit" className="absolute right-1 top-0 mt-3 mr-4">
            <svg className="text-gray-600 dark:text-gray-200 h-4 w-4 fill-current" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="0 0 56.966 56.966" xmlSpace="preserve" width="512px" height="512px">
